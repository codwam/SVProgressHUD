...
+ (SVProgressHUD*)sharedView {
    ...
    dispatch_once(&once, ^{ sharedView = [[self alloc] initWithFrame:[[UIApplication sharedApplication] keyWindow] window].bounds]; });
#else
...
- (UIControl*)controlView {
    ...
    // Update frames
#if !defined(SV_APP_EXTENSIONS)
    CGRect windowBounds = [[UIApplication sharedApplication] keyWindow] window].bounds;
